	...
	public function onCommand(CommandSender $sender, Command $cmd, string $label, array $args) : bool{
		...
		if($cmd->getname() == "guide"){
			if($sender instanceof Player){
				...
				$item->setPageText(1, "§3KYT is made up of 3 key components: §6Plots§3, §4Kit PvP §3&  §2Minigames§3.\n\n§6Plots §3is accessible by the Plots portal at Hub.\n\n§4Kit PvP §3is accessible by the §4Kit PvP §3portal at Hub.\n\n§2Minigames §3are accessible via the §2Minigames §3portal at Hub. ");
